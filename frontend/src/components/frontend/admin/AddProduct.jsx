...
const AddProduct = () => {
    ...
    const handleIDChange = (e) => {
        ...
        setProduct({ ...productInput, ma_san_pham: value });
    }
                ...
                return (
                    <>
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" name="screen" onChange={handleSpecInput} className="form-control" placeholder="VD: 6.8 inch Dynamic AMOLED 2X" />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label className="form-label text-muted">CPU</label>
                            <input type="text" name="cpu" onChange={handleSpecInput} className="form-control" placeholder="VD: Snapdragon 8 Gen 4" />
                        </div>
                        <div className="col-md-4 mb-3">
                            <label className="form-label text-muted">RAM</label>
                            <input type="text" name="ram" onChange={handleSpecInput} className="form-control" placeholder="VD: 12GB" />
                        </div>
                        <div className="col-md-4 mb-3">
                            <label className="form-label text-muted">Bộ nhớ trong</label>
                            <input type="text" name="storage" onChange={handleSpecInput} className="form-control" placeholder="VD: 512GB" />
                        </div>
                        <div className="col-md-4 mb-3">
                            <label className="form-label text-muted">Pin</label>
                            <input type="text" name="battery" onChange={handleSpecInput} className="form-control" placeholder="VD: 5000mAh" />
                        </div>
                    </>
                );
            case 2:
                return (
                    <>
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" name="screen_size" onChange={handleSpecInput} className="form-control" placeholder="VD: 65 inch" />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label className="form-label text-muted">Độ phân giải</label>
                            <input type="text" name="resolution" onChange={handleSpecInput} className="form-control" placeholder="VD: 4K, 8K" />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label className="form-label text-muted">Công nghệ</label>
                            <input type="text" name="technology" onChange={handleSpecInput} className="form-control" placeholder="VD: OLED, QLED" />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label className="form-label text-muted">Tần số quét</label>
                            <input type="text" name="refresh_rate" onChange={handleSpecInput} className="form-control" placeholder="VD: 120Hz" />
                        </div>
                    </>
                );
            case 3:
                return (
                    <>
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" name="capacity" onChange={handleSpecInput} className="form-control" placeholder="VD: 600L hoặc 2000W" />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label className="form-label text-muted">Loại</label>
                            <input type="text" name="type" onChange={handleSpecInput} className="form-control" placeholder="VD: Inverter, Cửa trước" />
                        </div>
                        <div className="col-md-12 mb-3">
                            <label className="form-label text-muted">Công nghệ nổi bật</label>
                            <input type="text" name="technology" onChange={handleSpecInput} className="form-control" placeholder="VD: Diet khuan Blue Ag+" />
                        </div>
                    </>
                );
            case 4:
                return (
                    <>
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" name="type" onChange={handleSpecInput} className="form-control" placeholder="VD: Tai nghe, Sạc dự phòng" />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label className="form-label text-muted">Kết nối / Cổng</label>
                            <input type="text" name="connection" onChange={handleSpecInput} className="form-control" placeholder="VD: USB-C, Bluetooth 5.3" />
                        </div>
                        <div className="col-md-12 mb-3">
                            <label className="form-label text-muted">Tính năng khác</label>
                            <input type="text" name="features" onChange={handleSpecInput} className="form-control" placeholder="VD: Chống ồn, Sạc nhanh" />
                        </div>
                    </>
                );
            default:
        ...
        <div className="admin-wrapper">
            ...
            <div className="admin-content px-4 pt-4">
                <div className="d-flex justify-content-between align-items-center mb-5 border-bottom pb-3">
                    <h3 className="m-0 text-dark fw-light">Thêm Sản Phẩm Mới</h3>
                    <Link to="/admin/view-product" className="btn btn-link text-decoration-none text-secondary">
                        <i className="fas fa-arrow-left me-1"></i> Quay lại
                    </Link>
                </div>
                
                <form onSubmit={submitProduct} encType="multipart/form-data" className="bg-white p-4 border">
                    <div className="row">
                        <div className="col-md-6 form-group mb-4">
                            ...
                            <input 
                                ...
                                className={`form-control border-top-0 border-start-0 border-end-0 rounded-0 bg-transparent px-0 ${errorList.ma_san_pham ? 'is-invalid' : ''}`} 
                        ...
                        <div className="col-md-12 form-group mb-4">
                            ...
                            {picture.preview && (
                                <div className="mt-3">
                                    <img src={picture.preview} alt="Preview" style={{ maxWidth: '200px', borderRadius: '4px' }} />
                                </div>
                            )}
                        </div>
